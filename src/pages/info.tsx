...
const InfoPage = () => {
  return (
    <Container>
      ...
      <h2>제1조(목적)</h2>
      <p>
        0hhanum(이하 '회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 '회사
      ...
      <h2>제5조(서비스 이용 및 부정 이용 확인을 위한 정보)</h2>
      <p>
      ...
      <p>필수 수집 정보: 서비스 이용기록 및 기기정보</p>

      <h2>제6조(기타 수집 정보)</h2>
      <p>회사는 아래와 같이 정보를 수집합니다.</p>
      <ul>
        <li>수집목적: 새로운 문제 추가 시 Push 알림</li>
        <li>수집정보: APNs 토큰</li>
      </ul>

      <h2>제7조(개인정보 수집 방법)</h2>
      ...
      <h2>제10조(법령에 따른 개인정보의 보유 및 이용기간)</h2>
      ...
      <h2>부칙</h2>
      <p>제1조 본 방침은 2024.04.01.부터 시행됩니다.</p>
    </Container>
  );
};
